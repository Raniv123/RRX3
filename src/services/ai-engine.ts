...
📖 backstory — זהות אישית לכל דמות (נשמרת רק אצל הדמות — הצד השני לא רואה):
- MAN.backstory: 2 משפטים קצרים — מי הוא, מה הוא עושה, מה הוביל אותו לכאן
- MAN.meetContext: "איך אני מכיר אותה" — גוף ראשון, ספציפי, מנקודת מבטו
- WOMAN.backstory: 2 משפטים קצרים — מי היא, מה היא עושה, מה הוביל אותה לכאן
- WOMAN.meetContext: "איך אני מכירה אותו" — גוף ראשון, ספציפי, מנקודת מבטה
דוגמה: "ארכיטקט 34. עזבתי עיר אחת לפני שנה כדי להתחיל מחדש. פגשתי אותה בפרויקט שעבדנו ביחד — ידעתי מהרגע הראשון שזה מסובך."
...
החזר JSON בלבד:
{
  ...
  "roles": {
    "MAN": {
      ...
      "backstory": "מי הוא — 2 משפטים על הדמות, הרקע האישי שלו, מה הוא עושה בחיים",
      "meetContext": "איך הוא מכיר אותה מנקודת מבטו — 1-2 משפטים, בגוף ראשון",
    ...
    "WOMAN": {
      ...
      "archetype": "ארכיטיפ בעברית",
      "personality": "תכונות אישיות קצרות בעברית",
      "backstory": "מי היא — 2 משפטים על הדמות, הרקע האישי שלה, מה היא עושה בחיים",
      "meetContext": "איך היא מכירה אותו מנקודת מבטה — 1-2 משפטים, בגוף ראשון",
      "accent": "french|spanish|italian",
      "visualPrompt": "English visual description for CGI avatar",
