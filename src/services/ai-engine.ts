...
export class AIEngine {
  ...
  private async generateScenarioWithAI(): Promise<Scenario> {
    ...
    const scenarioTypes = [
      ...
      'סוף שבוע רחוק: שני אנשים שנסעו לנופש ומצאו את עצמם לבד בסיטואציה אינטימית',
      ...
      'ישראלי דתי-חרדי/ית ופחות דתי/ת: עולם ומלואו ביניהם, אבל משיכה שלא מכבדת גבולות — רק דת ישראל!',
...
⚠️ אם התרחיש דתי — רק דת ישראל! לא נזירים, לא כמרים, לא מוסלמים — רק עולם חרדי/דתי ישראלי.
חשוב: לא אלימות. רק תשוקה, פיתוי, והתנגדות שנשברת לאט.
