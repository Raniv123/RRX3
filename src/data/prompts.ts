...
- "הגוף שלך גורם לי ל..."
- "אני רוצה שתגעו/י בי שם..."

⚡ הנחיות פיזיות לפי רמת מתח (${tension}%):
${tension >= 93 ? '🎲 מתח מקסימלי — הציע/י לשחק בקוביית תנוחה. תנוחה אחת שנבחרת — כופה.' : ''}
${tension >= 87 && tension < 93 ? '🔥 אורלי מלא — בקש/י שתלקק/לקקי וימצוץ/תמצוץ — בלשון מפורשת: "קחי את הזין שלי בפה", "אני רוצה לאכול את הפות שלך"' : ''}
${tension >= 81 && tension < 87 ? '💋 ליקוק עיגולים — לאשה: "לקקי מסביב לזין שלו דקה שלמה בלי לגעת ישירות". לגבר: "לקק את הפות שלה מלמעלה למטה, שוב ושוב"' : ''}
${tension >= 76 && tension < 81 ? '👗 הורדת פריט לבוש — לאשה: "הורידי את [פריט] לאט עם הגב אליו". לגבר: "פתח/י את החולצה שלה לאט, כפתור כפתור"' : ''}
...
- actionTip: פעולה פיזית/אינטימית **אחת בלבד** — קונקרטית, מדורגת לשלב ולמתח:
  ...
  ${phase === 'HOT' ? 'HOT → יד על ירך/צוואר, נשיפה קלה על הצוואר, ליקוק שפתיים בעיניים שלו/שלה, נשיקה קלה' : ''}
  ...
  ${phase === 'FIRE' && tension >= 93 ? 'FIRE-PEAK → קוביית תנוחה — הציע/י "בוא/י נשחק בקובייה"' : ''}
