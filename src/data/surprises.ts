...
export const SURPRISES: Surprise[] = [
  // DARE - מעשים נועזים (COMMON)
  {
    ...
    description: 'תוך 30 שניות הבאים — געו במקום שהצד השני לא מצפה לו',
    forWho: 'BOTH',
    minTension: 30,
    maxTension: 60,
    rarity: 'COMMON',
  ...
  },
  {
    ...
    type: 'DARE',
    title: 'אתגר הלחישה',
    description: 'לחשו משהו מלוכלך באוזן — רק לוחשים, לא אומרים בקול',
    forWho: 'BOTH',
    minTension: 40,
    maxTension: 70,
    rarity: 'COMMON'
  },
  {
    ...
    type: 'DARE',
    title: 'הילוך איטי',
    description: 'הסירו פריט בגד אחד — אבל לאט, מאוד לאט',
    forWho: 'BOTH',
    minTension: 50,
    maxTension: 80,
    rarity: 'RARE'
  ...
  // GAME - משחקים (RARE)
  {
    ...
    type: 'GAME',
    title: 'משחק כן אדוני',
    description: 'למשך דקה — צד אחד שואל, השני עונה רק "כן, אדוני" או "כן, גברתי"',
    forWho: 'BOTH',
    minTension: 50,
    maxTension: 75,
    rarity: 'RARE',
  ...
  // CHALLENGE - אתגרים (COMMON)
  {
    ...
    type: 'CHALLENGE',
    title: 'החלפת שפה',
    description: 'עברו לדבר רק בצרפתית, ספרדית או איטלקית למשך דקה',
    forWho: 'BOTH',
    minTension: 40,
    maxTension: 70,
    rarity: 'COMMON',
